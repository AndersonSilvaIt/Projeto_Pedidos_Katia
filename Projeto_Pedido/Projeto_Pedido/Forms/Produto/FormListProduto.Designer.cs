namespace Projeto_Pedido.Forms {
	partial class FormListProduto {
		...
		private void InitializeComponent()
		{
			...
			this.UnidadeMedidaString = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.ProdutoString.HeaderText = "Descrição";
			this.ProdutoString.Name = "ProdutoString";
			this.ProdutoString.ReadOnly = true;
			this.ProdutoString.Visible = false;
			// 
			// UM
			// 
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn UnidadeMedidaString;
